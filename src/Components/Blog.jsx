...
function Blog() {
  ...
  {/* -----------header--------------- */}
    <header>
      <div className="bg_sky min-vh-90 d-flex flex-column">
          ...
          <div className=" row justify-content-between align-items-center flex-column-reverse flex-md-row">
            <div className="col-12 col-md-6">
              <div>
                ...
                <a href="#" className="bg_highlight clr_primary pt_16 pb_16 ps-5 pe-5 fs_md fw-bold ff_sen text-decoration-none d-inline-block mt-2 mb-3 mb-md-0">Read More &gt;</a>
              </div>
            </div>
