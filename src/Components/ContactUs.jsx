      ...
      <div className="min-vh-100 container mb-3 mt-3 mb-md-5 mt-md-5">
        <div className="w-100 w_sm_75 w_lg_50 m-auto pt-3 pt-md-5">
          ...
          <form action="" className="pt-2">
            ...
            <input type="submit" value="Send Message" className="bg_highlight clr_primary pt_16 pb_16 fs_md fw-bold ff_sen text-decoration-none d-inline-block w-100 border-0 mb-3 mb-lg-5" />
